...
|---|---|
| Build your first real agent | [Foundations Path](./learning-paths/01-foundations/) |
| Build retrieval-augmented agents | [Agentic RAG Path](./learning-paths/02-agentic-rag/) |
| Orchestrate multiple cooperating agents | [Multi-Agent Systems Path](./learning-paths/03-multi-agent-systems/) |
| Wire agents to tools, data, and other agents | [Tool Protocols (MCP + A2A) Path](./learning-paths/04-tool-protocols-mcp-a2a/) |
| Get more out of the context window | [Context Engineering Path](./learning-paths/05-context-engineering/) |
| Add tracing, evals, and observability | [Evaluation & Observability Path](./learning-paths/06-evaluation-observability/) |
| Ship to production safely | [Production & Safety Path](./learning-paths/07-production-and-safety/) |
| Understand the math behind it all | [Mathematical Foundations Path](./learning-paths/08-mathematical-foundations/) |
| Build something portfolio-worthy | [Capstone Projects Path](./learning-paths/09-capstones/) |

Each path is a curated reading list across the rest of the repo — concepts, labs, recipes, patterns — not a duplicate folder of content.
