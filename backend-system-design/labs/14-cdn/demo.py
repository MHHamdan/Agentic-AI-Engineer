...
TOPIC = "CDN"
FOCUS = "serve static objects from an edge cache near users"
BASELINE_STRATEGY = "origin_only"
IMPROVED_STRATEGY = "edge_cache"
PRIMARY_METRIC = "origin_requests"
