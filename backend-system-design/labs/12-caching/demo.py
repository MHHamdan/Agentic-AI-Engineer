...
TOPIC = "Caching"
FOCUS = "serve repeated reads from cache instead of repeatedly hitting the database"
BASELINE_STRATEGY = "database_only"
IMPROVED_STRATEGY = "read_through_cache"
PRIMARY_METRIC = "database_reads"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 8, "operations": 10},
    )
