"""Tests for the Proxy vs Reverse Proxy runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Proxy vs Reverse Proxy"
    assert summary["primary_metric"] == "visible_origins"
...
def test_main_prints_summary(capsys):
    ...
    assert "Proxy vs Reverse Proxy lab" in output
