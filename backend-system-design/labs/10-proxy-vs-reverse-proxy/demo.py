"""Runnable lab demo for Proxy vs Reverse Proxy."""
...
FOCUS = "route client traffic through a reverse proxy to hide internal services"
BASELINE_STRATEGY = "direct_origin_access"
IMPROVED_STRATEGY = "reverse_proxy_routing"
PRIMARY_METRIC = "visible_origins"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    improved = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 1, "operations": 10},
    )
