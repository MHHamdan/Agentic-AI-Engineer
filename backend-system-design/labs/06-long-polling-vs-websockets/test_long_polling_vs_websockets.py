"""Tests for the Long Polling vs WebSockets runnable lab."""
...
def load_demo_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "lab_06_long_polling_vs_websockets",
        module_path,
    )
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Long Polling vs WebSockets"
    assert summary["primary_metric"] == "delivery_latency_ms"
...
def test_main_prints_summary(capsys):
    ...
    assert "Long Polling vs WebSockets lab" in output
