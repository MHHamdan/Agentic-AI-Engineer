"""Runnable lab demo for Scalability."""
...
TOPIC = "Scalability"
FOCUS = "add workers to increase throughput while keeping utilization below target"
BASELINE_STRATEGY = "fixed_capacity"
IMPROVED_STRATEGY = "scaled_workers"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    improved = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 64, "operations": 10},
    )
