"""Tests for the Stateful vs Stateless runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Stateful vs Stateless"
    assert summary["primary_metric"] == "failed_after_restart"
...
def test_main_prints_summary(capsys):
    ...
    assert "Stateful vs Stateless lab" in output
