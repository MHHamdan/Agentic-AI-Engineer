"""Runnable lab demo for Concurrency vs Parallelism."""
...
FOCUS = "compare interleaved IO work with parallel CPU work"
BASELINE_STRATEGY = "sequential_tasks"
IMPROVED_STRATEGY = "concurrent_tasks"
PRIMARY_METRIC = "elapsed_ticks"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 12, "operations": 10},
    )
