"""Tests for the Concurrency vs Parallelism runnable lab."""
...
def load_demo_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "lab_26_concurrency_vs_parallelism",
        module_path,
    )
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Concurrency vs Parallelism"
    assert summary["primary_metric"] == "elapsed_ticks"
...
def test_main_prints_summary(capsys):
    ...
    assert "Concurrency vs Parallelism lab" in output
