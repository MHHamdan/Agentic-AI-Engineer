"""Runnable lab demo for Single Point of Failure."""
...
FOCUS = "remove one critical dependency whose failure stops the whole service"
BASELINE_STRATEGY = "critical_single_node"
IMPROVED_STRATEGY = "redundant_node"
PRIMARY_METRIC = "failed_requests"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 5, "operations": 10},
    )
