"""Tests for the Single Point of Failure runnable lab."""
...
def load_demo_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "lab_21_single_point_of_failure",
        module_path,
    )
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Single Point of Failure"
    assert summary["primary_metric"] == "failed_requests"
...
def test_main_prints_summary(capsys):
    ...
    assert "Single Point of Failure lab" in output
