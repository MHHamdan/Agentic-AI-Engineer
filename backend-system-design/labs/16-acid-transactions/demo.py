"""Runnable lab demo for ACID Transactions."""
...
FOCUS = "commit related updates atomically or roll them back together"
BASELINE_STRATEGY = "partial_update"
IMPROVED_STRATEGY = "transaction"
PRIMARY_METRIC = "inconsistent_records"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 2, "operations": 10},
    )
