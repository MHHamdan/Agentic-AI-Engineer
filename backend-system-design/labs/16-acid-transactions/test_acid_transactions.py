"""Tests for the ACID Transactions runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "ACID Transactions"
    assert summary["primary_metric"] == "inconsistent_records"
...
def test_main_prints_summary(capsys):
    ...
    assert "ACID Transactions lab" in output
