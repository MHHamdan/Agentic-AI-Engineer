"""Tests for the Batch vs Stream Processing runnable lab."""
...
def load_demo_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "lab_27_batch_vs_stream_processing",
        module_path,
    )
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Batch vs Stream Processing"
    assert summary["primary_metric"] == "freshness_lag_seconds"
...
def test_main_prints_summary(capsys):
    ...
    assert "Batch vs Stream Processing lab" in output
