"""Runnable lab demo for Batch vs Stream Processing."""
...
FOCUS = "process events continuously instead of waiting for a batch window"
BASELINE_STRATEGY = "nightly_batch"
IMPROVED_STRATEGY = "streaming_pipeline"
PRIMARY_METRIC = "freshness_lag_seconds"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 3600, "operations": 10},
    )
    improved = ScenarioResult(
        strategy=IMPROVED_STRATEGY,
        metrics={PRIMARY_METRIC: 10, "operations": 10},
    )
