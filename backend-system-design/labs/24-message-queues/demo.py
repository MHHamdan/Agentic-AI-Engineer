"""Runnable lab demo for Message Queues."""
...
FOCUS = "buffer work so producers and consumers can run at different speeds"
BASELINE_STRATEGY = "synchronous_processing"
IMPROVED_STRATEGY = "queued_processing"
PRIMARY_METRIC = "producer_blocked_ms"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 750, "operations": 10},
    )
    improved = ScenarioResult(
        strategy=IMPROVED_STRATEGY,
        metrics={PRIMARY_METRIC: 120, "operations": 10},
    )
