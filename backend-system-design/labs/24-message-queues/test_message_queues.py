"""Tests for the Message Queues runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Message Queues"
    assert summary["primary_metric"] == "producer_blocked_ms"
...
def test_main_prints_summary(capsys):
    ...
    assert "Message Queues lab" in output
