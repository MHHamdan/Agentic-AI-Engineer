"""Runnable lab demo for SQL vs NoSQL."""
...
TOPIC = "SQL vs NoSQL"
FOCUS = "compare relational joins with document-shaped reads for access patterns"
BASELINE_STRATEGY = "wrong_storage_shape"
IMPROVED_STRATEGY = "matched_storage_model"
PRIMARY_METRIC = "query_steps"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 9, "operations": 10},
    )
    improved = ScenarioResult(
        strategy=IMPROVED_STRATEGY,
        metrics={PRIMARY_METRIC: 4, "operations": 10},
    )
