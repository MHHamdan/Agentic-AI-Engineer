"""Tests for the CAP Theorem runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "CAP Theorem"
    assert summary["primary_metric"] == "conflicting_writes"
...
def test_main_prints_summary(capsys):
    ...
    assert "CAP Theorem lab" in output
