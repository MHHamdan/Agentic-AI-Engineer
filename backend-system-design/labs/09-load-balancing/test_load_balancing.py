"""Tests for the Load Balancing runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Load Balancing"
    assert summary["primary_metric"] == "max_backend_load"
...
def test_main_prints_summary(capsys):
    ...
    assert "Load Balancing lab" in output
