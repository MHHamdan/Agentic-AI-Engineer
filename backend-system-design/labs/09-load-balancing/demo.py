"""Runnable lab demo for Load Balancing."""
...
FOCUS = "spread requests across healthy backend instances"
BASELINE_STRATEGY = "single_backend"
IMPROVED_STRATEGY = "round_robin"
PRIMARY_METRIC = "max_backend_load"
