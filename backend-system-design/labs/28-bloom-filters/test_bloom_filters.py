"""Tests for the Bloom Filters runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Bloom Filters"
    assert summary["primary_metric"] == "store_lookups"
...
def test_main_prints_summary(capsys):
    ...
    assert "Bloom Filters lab" in output
