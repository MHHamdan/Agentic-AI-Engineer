"""Runnable lab demo for Bloom Filters."""
...
TOPIC = "Bloom Filters"
FOCUS = "prefilter definite misses before doing expensive lookups"
BASELINE_STRATEGY = "always_check_store"
IMPROVED_STRATEGY = "bloom_prefilter"
PRIMARY_METRIC = "store_lookups"
