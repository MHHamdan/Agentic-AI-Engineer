"""Runnable lab demo for Sharding."""
...
TOPIC = "Sharding"
FOCUS = "split data across shards using a shard key"
BASELINE_STRATEGY = "single_shard"
IMPROVED_STRATEGY = "hash_shards"
PRIMARY_METRIC = "max_shard_items"
