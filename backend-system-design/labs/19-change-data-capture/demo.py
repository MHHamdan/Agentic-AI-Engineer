"""Runnable lab demo for Change Data Capture."""
...
FOCUS = "publish database changes to downstream consumers"
BASELINE_STRATEGY = "polling_export"
IMPROVED_STRATEGY = "change_log_stream"
PRIMARY_METRIC = "replication_lag_ms"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 900, "operations": 10},
    )
