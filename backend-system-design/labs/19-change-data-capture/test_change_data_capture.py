"""Tests for the Change Data Capture runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Change Data Capture"
    assert summary["primary_metric"] == "replication_lag_ms"
...
def test_main_prints_summary(capsys):
    ...
    assert "Change Data Capture lab" in output
