"""Runnable lab demo for Idempotency."""
...
TOPIC = "Idempotency"
FOCUS = "deduplicate retried write requests using an idempotency key"
BASELINE_STRATEGY = "duplicate_writes"
IMPROVED_STRATEGY = "idempotency_keys"
PRIMARY_METRIC = "created_records"
