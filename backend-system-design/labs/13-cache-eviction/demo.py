"""Runnable lab demo for Cache Eviction."""
...
FOCUS = "evict less useful entries when cache capacity is full"
BASELINE_STRATEGY = "clear_all_cache"
IMPROVED_STRATEGY = "lru_eviction"
PRIMARY_METRIC = "cache_misses"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 7, "operations": 10},
    )
