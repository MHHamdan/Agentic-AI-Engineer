"""Tests for the Cache Eviction runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Cache Eviction"
    assert summary["primary_metric"] == "cache_misses"
...
def test_main_prints_summary(capsys):
    ...
    assert "Cache Eviction lab" in output
