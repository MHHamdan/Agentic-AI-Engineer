"""Runnable lab demo for Consistent Hashing."""
...
FOCUS = "add a node while moving only a subset of keys"
BASELINE_STRATEGY = "modulo_hashing"
IMPROVED_STRATEGY = "consistent_hash_ring"
PRIMARY_METRIC = "moved_keys"
