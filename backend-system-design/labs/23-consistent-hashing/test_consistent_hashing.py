"""Tests for the Consistent Hashing runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Consistent Hashing"
    assert summary["primary_metric"] == "moved_keys"
...
def test_main_prints_summary(capsys):
    ...
    assert "Consistent Hashing lab" in output
