"""Runnable lab demo for Geohashing."""
...
TOPIC = "Geohashing"
FOCUS = "bucket coordinates by geohash prefix for nearby search"
BASELINE_STRATEGY = "scan_all_locations"
IMPROVED_STRATEGY = "prefix_bucket_lookup"
PRIMARY_METRIC = "locations_scanned"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 100, "operations": 10},
    )
