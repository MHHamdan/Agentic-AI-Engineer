...
TOPIC = "Indexes"
FOCUS = "use an index to avoid scanning every row for a lookup"
BASELINE_STRATEGY = "full_scan"
IMPROVED_STRATEGY = "indexed_lookup"
PRIMARY_METRIC = "rows_scanned"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 1000, "operations": 10},
    )
