"""Runnable lab demo for Rate Limiting."""
...
TOPIC = "Rate Limiting"
FOCUS = "limit burst traffic so accepted requests stay inside service capacity"
BASELINE_STRATEGY = "unlimited_requests"
IMPROVED_STRATEGY = "token_bucket"
PRIMARY_METRIC = "accepted_requests"
...
def compare_strategies() -> dict[str, ScenarioResult]:
    ...
    baseline = ScenarioResult(
        ...
        metrics={PRIMARY_METRIC: 18, "operations": 10},
    )
