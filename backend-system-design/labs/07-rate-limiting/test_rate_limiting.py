"""Tests for the Rate Limiting runnable lab."""
...
def test_run_demo_identifies_topic():
    ...
    assert summary["topic"] == "Rate Limiting"
    assert summary["primary_metric"] == "accepted_requests"
...
def test_main_prints_summary(capsys):
    ...
    assert "Rate Limiting lab" in output
