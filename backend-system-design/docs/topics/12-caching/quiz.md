...
2. Which metric is useful for this topic?
   - A) hit rate, miss rate, staleness, eviction count, and memory usage
...
1. Explain Caching in one or two sentences.
...
1. Where would Caching appear in a backend architecture?
