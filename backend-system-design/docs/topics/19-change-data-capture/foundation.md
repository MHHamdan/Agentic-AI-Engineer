...
Change Data Capture works by making an explicit engineering tradeoff. The system accepts constraints such as memory, latency, consistency, ordering, or operational complexity in exchange for better behavior under realistic load.

## Request or Data Flow

1. A client, producer, or worker creates work.
2. The system applies the Change Data Capture design decision.
...
- Add dashboards for capture lag, event throughput, duplicate rate, and replay success
