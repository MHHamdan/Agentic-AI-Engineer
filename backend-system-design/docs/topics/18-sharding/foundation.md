...
Sharding works by making an explicit engineering tradeoff. The system accepts constraints such as memory, latency, consistency, ordering, or operational complexity in exchange for better behavior under realistic load.

## Request or Data Flow

1. A client, producer, or worker creates work.
2. The system applies the Sharding design decision.
...
- Add dashboards for shard balance, hot shard rate, cross-shard query count, and rebalancing cost
