...
When utilization approaches 100%, queues grow quickly and tail latency becomes unstable. Sharding is usually about keeping the system inside a predictable operating range.
...
Track shard balance, hot shard rate, cross-shard query count, and rebalancing cost. These measurements show whether theory matches production reality.
