...
| 07 | [Production & Safety](./07-production-and-safety/) | Engineers taking agents to production | 🔴 Advanced | 🚧 v1 in progress — Modules 1 + 8 shipped (Batch 55: `production/deployment.md` + `production/checklist.md`) |
