...
| 04 | [Tool Protocols (MCP + A2A)](./04-tool-protocols-mcp-a2a/) | Engineers wiring agents to tools and other agents | 🟡 Intermediate | 🚧 Modules 1+2+3+4+5 shipped (Batch 48); Modules 6-7 planned |
...
| 02 Agentic RAG | ☑ | ● | ● | ☐ | ☐ | ☐ |
| 03 Multi-Agent Systems | ☑ | ● | ● | ☐ | ● | ☐ |
| 04 Tool Protocols (MCP + A2A) | ☑ | ● (5 of ~10) | ● (4 of ~5) | ☐ | ☐ | ☐ |
| 05 Context Engineering | ☑ | ☐ | ☐ | ☐ | ☐ | ☐ |
| 06 Evaluation & Observability | ☑ | ● | ● | ● | ● | ● |
| 07 Production & Safety | ☑ | ☐ | ☐ | ☐ | ☐ | ☐ |
