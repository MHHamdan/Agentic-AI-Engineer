...
| 07 | [Production & Safety](./07-production-and-safety/) | Engineers taking agents to production | 🔴 Advanced | 🚧 v1 in progress — 6 of 8 modules shipped (Batches 55-57: deployment, cost engineering, streaming + async, prompt injection, tool abuse + exfiltration, pre-launch checklist) |
